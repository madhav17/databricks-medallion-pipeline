...
End-to-end synthetic e-commerce pipeline:

CSV → Bronze → Silver → Gold → Databricks SQL Dashboard

Implemented locally with PySpark and configuration-driven paths compatible with
Databricks execution.

## Responsible AI Statement

- All datasets are synthetic; no real customer PII is used.
